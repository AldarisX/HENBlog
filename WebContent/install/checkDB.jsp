...
<script type="text/javascript">
	var mysqlIsError=<%=GetInstall.mysqlIsERROR%>;
	var freeSpaceERROR=<%=GetInstall.freeSpaceIsERROR%>;
	var isDBEx=<%=GetInstall.isDBEx%>;
...
<body>
	...
	<div class="page" align="center">
		<div class="main mui-row" align="left">
			<div class="init">
				<legend>条件</legend>
				<p class="mysql">MySQL5.5或以上&nbsp;&nbsp;&nbsp;&nbsp;<%=GetInstall.mysqlState%></p>
				<p class="disk">磁盘剩余128MB(缓存,上载图片需要)&nbsp;&nbsp;&nbsp;&nbsp;<%=GetInstall.freeSpaceState%></p>
